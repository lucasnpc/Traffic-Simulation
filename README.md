# CPPNanodegree: Program a Concurrent Traffic Simulation

This is the project for the fourth course in the [Udacity C++ Nanodegree Program](https://www.udacity.com/course/c-plus-plus-nanodegree--nd213): Concurrency. 

<img src="data/traffic_simulation.gif"/>

The Traffic Simulation code creates a view of Paris where vehicles can enter and leave some intersections. After that, the vehicles will starting moving through each intersection, represented by green and red lights.

The vehicles will await to enter the intersection if the light is red, when the light is green the vehicle enters the intersection. The tasks required to create this program are detailed below.
